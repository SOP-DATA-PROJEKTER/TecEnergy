...
//     return this.http.get<MeterData>('https://localhost:7141/Room/EnergyDto/4E10F56A-147E-4541-ADE4-08DBEF4BCA36');
//   }

//   getSubMeterData(id : string): Observable<MeterData[]> 
//   {
//     // return this.http.get<MeterData[]>(this.url+'EnergyMeterListDto/' + id);
//     return this.http.get<MeterData[]>('https://localhost:7141/Room/EnergyMeterListDto/DDADA893-0D4C-41E6-F1C7-08DBFA4515B7');
//   }
...
//       o.next({Id:"224AF2AB-A495-44DC-1FB7-08DBEF442E9B", Name:"E"}); 
//      });
//   }
...
//     return this.http.get<SimpleInfo[]>('https://localhost:7141/room/SimpleList/224AF2AB-A495-44DC-1FB7-08DBEF442E9B');
//   }
// }
